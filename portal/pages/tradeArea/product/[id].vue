    ...
    <div class="demand-detail-page">
      <template v-if="demandForm.status == 3">
        <el-card class="detail-card" :body-style="{ padding: '20px' }">
          <div class="meta-wrap">
            <div class="poster">
              <img :src="demandForm.image || defaultProductIcon" alt="产品图片">
            </div>
            <div>
      ...
      <template v-else>
        <el-card v-if="isLoading === false" class="detail-card" :body-style="{ padding: '20px' }">
          <div class="empty">
            <img style="width: 350px;height: 350px;" src="@/assets/img/workbench/tradeArea/product_banned.png"
              alt="产品已下架" />
            <span>产品已下架</span>
          </div>
        </el-card>
...
import { defaultProductIcon } from '@/pages/workbench/tradeArea/data'
