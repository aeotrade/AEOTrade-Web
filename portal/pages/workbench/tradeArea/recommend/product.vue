    ...
    <div class="content-card">
      ...
      <el-card class="table-card" shadow="never">
        <el-table :data="tableData" style="width: 100%" stripe>
          <el-table-column prop="supplyTxId" label="产品编号"></el-table-column>
          <el-table-column prop="supplyName" label="产品名称" :show-overflow-tooltip="true"></el-table-column>
          <el-table-column prop="demandName" label="匹配需求名称" :show-overflow-tooltip="true"></el-table-column>
          ...
          <el-table-column prop="demandOrgName" label="需求方"></el-table-column>
          <el-table-column prop="demandCircleName" label="圈子"></el-table-column>
...
<script setup>
import { getAiMatchDemand } from '@/api/api'
...
const handleSearch = async () => {
  const res = await getAiMatchDemand({
...
const handleViewDetails = (row) => {
  window.open('/tradeArea/demand/' + row.demandId, '_blank');
};
