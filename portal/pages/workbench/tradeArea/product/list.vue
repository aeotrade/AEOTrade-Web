<template>
  <div class="demand-release-page">
    ...
    <el-breadcrumb separator="/" class="bread">
      <el-breadcrumb-item>
        <span style="font-size: 14px; color: #101010">产品发布</span>
      </el-breadcrumb-item>
    </el-breadcrumb>
    ...
    <div class="content-card">
      <el-card class="search-card" shadow="never">
        <el-form :inline="true" :model="searchForm" class="search-form">
          ...
          <el-form-item label="发布状态:">
            <el-select style="width: 220px;" v-model="searchForm.status" placeholder="请选择">
      ...
      <el-card class="table-card" shadow="never">
        <div class="table-header">
          <el-button type="primary" @click="handleCreateDemand">创建产品</el-button>
        </div>
        ...
        <el-table :data="allDemands" style="width: 100%" stripe>
          ...
          <el-table-column width="80" label="图片">
            <template #default="{ row }">
              <el-image style="width: 50px; height: 50px" :src="row.imageUrl" fit="cover" />
            </template>
          </el-table-column>
...
import { statusOption, statusMap } from '../data'
